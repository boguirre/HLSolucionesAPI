...
class CreateSeguimientoEspecializadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('seguimiento_especializados', function (Blueprint $table) {
            $table->id();
            $table->string('ot');
            $table->string('oc');
    ...
    {
        Schema::dropIfExists('seguimiento_especializados');
    }
}
